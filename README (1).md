...
El código C# importa un módulo externo llamado `SM` mediante `Py.Import("SM")`. Para utilizar esa funcionalidad se debe disponer del archivo `SM.py` y configurar en el código la carpeta donde se encuentra.
